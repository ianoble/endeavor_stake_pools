...
class StackedFillColorBarChart extends StatelessWidget {
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    final desktopSalesData = [
      new OrdinalSales('215', 2),
      new OrdinalSales('216', 3),
      new OrdinalSales('217', 2),
      new OrdinalSales('218', 0),
    ];

    final tableSalesData = [
      new OrdinalSales('215', 0),
      new OrdinalSales('216', 0),
      new OrdinalSales('217', 0),
      new OrdinalSales('218', 1),
    ];
